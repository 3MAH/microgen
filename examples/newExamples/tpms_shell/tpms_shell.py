...
# shell = cq.importers.importStep('shell.step')
# inside = cq.importers.importStep('inside.step')
# compound = cq.importers.importStep('compound.step')
# cq.exporters.export(compound, 'geom.stl')
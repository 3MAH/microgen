...
'''
We could in future versions make benefit of the embree library with multi ray tracing embedded in PyVista. However a very old version of embree (2) is nowadays binded in python
# try:
#     import trimesh
#     import rtree
#     import pyembree

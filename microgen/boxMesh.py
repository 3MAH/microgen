...
class BoxMesh(PhaseMesh):
    ...
    def _build_rve(
        ...
        """
        build a a representative volume element (Rve) of the considered mesh from its bounding box
    ...
    def _closest_points_on_faces(
        ...
        :return dict: a dictionnary with (np.array) of indices and an np.array of distances for each neigboor:
    ...
    def closest_cells_on_boundaries(
        ...
        return {
            'face_Xp' : (list_cells_for_each_face[0], list_ray_trace[0][0], list_cells_for_each_face[0][list_ray_trace[0][2]]),
            'face_Yp' : (list_cells_for_each_face[1], list_ray_trace[1][0], list_cells_for_each_face[1][list_ray_trace[1][2]]), 
            'face_Zp' : (list_cells_for_each_face[2], list_ray_trace[2][0], list_cells_for_each_face[2][list_ray_trace[2][2]])
        }    

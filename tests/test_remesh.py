import subprocess
import pytest
from microgen import Rve, remesh, Tpms, BoxMesh, is_periodic
...
def test_given_periodic_mesh_remesh_keeping_periodicity_for_fem_must_maintain_periodicity(
    ...
    if USE_MMG == True:
        ...
        # Assert
        assert is_periodic(_get_mesh_nodes_coords(tmp_mesh_filename)) and is_periodic(_get_mesh_nodes_coords(tmp_output_mesh_filename))